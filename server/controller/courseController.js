...
export const createCourse = async (req, res, next) => {
    try {
        const { title, description, category, createdBy, youtubeLink } = req.body
        if (!title || !description || !category || !createdBy || !youtubeLink) {
...
export const updateCourse = async (req, res, next) => {
    try {
        ...
        const course = await Course.findByIdAndUpdate(
            id,
            {
                $set: { title, description, category, createdBy, youtubeLink }, // Update youtubeLink here
            },
