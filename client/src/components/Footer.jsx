...
function Footer() {
    ...
    return (
        <>
              <footer className="bg-white py-5 lg:px-20 px-8 gap-4 w-full flex flex-col md:flex-row lg:flex-row justify-between items-end">
                <span className="lg:text-lg md:text-lg text-slate-600"> created BY Puskar Mishra Copyright @{2024} All rights reserve </span>
